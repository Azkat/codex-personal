---
name: daily-report
description: ユーザーのローカル日次レポート自動化を扱うときに使う。Obsidianデイリーノート、YouTubeお気に入り（API上は高評価）、Inoreader OPML/RSS、Raindrop API、launchd定期実行、出力フォーマットの修正やトラブルシュートを対象にする。
---
...
- 個人用Codex skillsリポジトリ: `~/.codex/skills`
- daily-reportプロジェクト正本: `~/.codex/skills/_projects/daily-report`
- 互換リンク: `~/.codex/projects/daily-report`
- 運用README: `~/.codex/projects/daily-report/app/README.md`
- GitHub向けREADME: `~/.codex/skills/README.md`
...
- RSS、YouTubeお気に入り、RaindropはMarkdown表で出す。
- `10:30` のような時刻列は出さない。
